...
export interface VisitRescheduledClientProps {
  memberName: string;
  serviceName: string;
  date: string;
  time: string;
...
export const VisitRescheduledClient = ({
  memberName,
  serviceName,
  date,
  time,
  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={footer}>
          A calendar invite with the new time is attached. If you need to make further changes,
          please contact us.
        </Text>
      </Container>
    </Body>
...
export default VisitRescheduledClient;
